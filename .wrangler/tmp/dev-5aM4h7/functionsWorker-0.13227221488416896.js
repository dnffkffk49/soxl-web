...
// .wrangler/tmp/pages-npaL1f/functionsWorker-0.13227221488416896.mjs
...
async function onRequestGet() {
  ...
  try {
    ...
    for (var i = 0; i < ts.length; i++) {
      ...
      var d = new Date(ts[i] * 1e3).toISOString().slice(0, 10);
      prices.push({ d, c: Math.round(c * 100) / 100 });
    }
    return json({ prices, fetchedAt: (/* @__PURE__ */ new Date()).toISOString() }, 200, 900);
  } catch (e) {
...
// .wrangler/tmp/bundle-CaLyQH/middleware-insertion-facade.js
...
// .wrangler/tmp/bundle-CaLyQH/middleware-loader.entry.ts
...
//# sourceMappingURL=functionsWorker-0.13227221488416896.js.map
